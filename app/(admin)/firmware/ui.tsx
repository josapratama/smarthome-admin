...
function UploadFirmwareDialog() {
  ...
  const uploadMutation = useMutation({
    mutationFn: async (data: { formData: typeof formData; file: File }) => {
      ...
      form.append("deviceType", data.formData.deviceType);
      form.append("releaseNotes", data.formData.releaseNotes);
      form.append("isStable", data.formData.isStable.toString());
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: qk.firmwareReleases() });
      setOpen(false);
      setFormData({
        version: "",
        deviceType: "OTHER",
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, isStable: e.target.checked }))
              }
            />
                ...
                >
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Badge variant="outline">{firmware.deviceType}</Badge>
                      {firmware.isStable ? (
